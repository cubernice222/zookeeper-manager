 ...
 */
public class ZkPropsHolderConfigure extends ZkPropsConfigurerSupport {
    ...
    private class PropertyPlaceholderConfigurerResolver implements PropertyPlaceholderHelper.PlaceholderResolver {
        ...
        public String resolvePlaceholder(String placeholderName) {
            return ZkPropsHolderConfigure.this.resolvePlaceholder(placeholderName, props, systemPropertiesMode);
        }
    }
}
